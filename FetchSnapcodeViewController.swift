...
class FetchSnapcodeViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        backbutton = UIButton(frame: CGRect(x: 6, y: 30, width: 39, height: 28))
     //   backbutton.setTitle(" ", for: .normal)
        backbutton.setBackgroundImage(UIImage.init(named: "ic_back"), for: .normal)
        backbutton.setTitleColor(UIColor.snapBlack, for: .normal)
        backbutton.addTarget(self, action: #selector(getwindowButtonWasPressed), for: .touchUpInside)
    ...
    @objc func getwindowButtonWasPressed(){
